...
/**
 * @file vmstat.h
 * Collect cpu::vm stats via kstats.
 */

#ifndef SOLMEX_VMSTAT_H
#define SOLMEX_VMSTAT_H
...
typedef enum vm_stat_quantity {
	VMSTAT_NONE = 0,
	VMSTAT_NORMAL,		/**< Just basic metrics usually sufficient in day-by-day work */
	VMSTAT_EXTENDED,	/**< Add detailed metrics for exec, anon and file pages */
	VMSTAT_ALL			/**< Emitt all metrics provided by `kstat cpu::vm` */
} vm_stat_quantity_t;
 ...
 */
void collect_vmstat(psb_t *sb, bool compact, kstat_ctl_t *kc, hrtime_t now,
